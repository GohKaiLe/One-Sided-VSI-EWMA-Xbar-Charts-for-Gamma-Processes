% ATS Optimisation of the Lower One-sided VSI EWMA X-bar Chart %
% Gamma distribution % 
% Zero State % 
...
[lam, hL, K1, K2, ATS1, SDTS1, ASI1, ATS0, SDTS0, ASI0] = OptAtsLowerVsiEwmaXbarGam(n, hS, delta, tau0, a_shape, b_scale);
