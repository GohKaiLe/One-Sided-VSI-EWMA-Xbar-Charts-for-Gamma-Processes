% EATS Optimisation of the Lower One-sided VSI EWMA X-bar Chart
% Gamma distribution % 
% Zero State % 
...
[lam, hL, K1, K2, EATS1, ATS0, ASI0] = OptAtsLowerVsiEwmaXbarGamEATS(n, hS, deltamin, deltamax, tau0, a_shape, b_scale) ;
...
for i = 1:length(delta_list)
    ...
    [ATS1, SDTS1, ~] = TsLowerVsiEwmaXbarGam(n, hL, hS, lam, K1, K2, delta, a_shape, b_scale) ; 
