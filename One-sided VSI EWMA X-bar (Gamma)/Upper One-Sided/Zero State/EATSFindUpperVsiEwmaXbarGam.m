...
function [EATS] = EATSFindUpperVsiEwmaXbarGam(n, deltamin, deltamax, hL, hS, lam, K1, K2, a_shape, b_scale)
...
for i = 1:h 
    ...
    [ATS, ~, ~] = TsUpperVsiEwmaXbarGam(n, hL, hS, lam, K1, K2, d, a_shape, b_scale) ;
