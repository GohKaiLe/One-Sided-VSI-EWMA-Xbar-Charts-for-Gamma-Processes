% ATS optimisation of the Upper One-sided VSI EWMA X-bar Chart %
% Gamma distribution % 
% Zero State %
...
[lam, hL, K1, K2, ATS1, SDTS1, ASI1, ATS0, SDTS0, ASI0] = OptAtsUpperVsiEwmaXbarGam(n, hS, delta, tau0, a_shape, b_scale);
...
results = [delta, n, hS, lam, hL, K1, K2, ATS1, SDTS1, ATS0, ASI0] ;
disp(results)
