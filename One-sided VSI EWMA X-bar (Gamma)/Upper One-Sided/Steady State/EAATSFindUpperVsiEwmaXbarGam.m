...
function [EAATS] = EAATSFindUpperVsiEwmaXbarGam(n, deltamin, deltamax, hL, hS, lam, K1, K2, a_shape, b_scale)
...
for i = 1:h 
    ...
    [AATS, ~, ~] = TsUpperVsiEwmaXbarGamSteady(n, hL, hS, lam, K1, K2, d, a_shape, b_scale) ;
