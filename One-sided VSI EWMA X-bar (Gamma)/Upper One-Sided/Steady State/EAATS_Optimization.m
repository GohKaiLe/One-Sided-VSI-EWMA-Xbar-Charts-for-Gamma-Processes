...
[lam, hL, K1, K2, EAATS1, AATS0, ASI0] = OptAtsUpperVsiEwmaXbarGamEAATS(n, hS, deltamin, deltamax, tau0, a_shape, b_scale) ;
...
disp(['Sample size             : ', num2str(n,'%0.0f')])
disp(['The shift size domain   : Minimum = ', num2str(deltamin,'%0.2f'), ', Maximum= ', num2str(deltamax,'%0.2f')])
...
for i = 1:length(delta_list)
    ...
    [AATS1, SDATS1, ~] = TsUpperVsiEwmaXbarGamSteady(n, hL, hS, lam, K1, K2, delta, a_shape, b_scale) ; 
